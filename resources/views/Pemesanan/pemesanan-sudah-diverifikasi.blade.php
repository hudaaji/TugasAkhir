        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" aria-current="page" href="{{route('sudahverif')}}">Sudah Diverifikasi <span class="badge bg-secondary">{{$count[1]}}</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('sudahselesai')}}"> Pesanan Selesai <span class="badge bg-secondary">{{$count[4]}}</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <tr>
                        ...
                        @if (auth()->user()->role =="admin")
                            @if ($p->keterangan == 0)
                                ...
                                @if ($p->waktu <= $deadline)
                                    <br>
                                <a href="{{route('blokir2',$p->id)}}"><button class="btn btn-danger"> Blokir </button></a>
                                @endif
                                  </td>
                                        ...
                                        <div class="modal-body" style="text-align:left;">
                                            ...
                                            <input type="hidden" name="pemesanan_id" value="{{$p->id}}">
                                                ...
                                                {{--  <div class="form-group">
                                                    ...
                                                    <input name="disisa" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$p->transaksi->sisa}}" readonly>
                                                </div>  --}}
                                                <div class="form-group">
